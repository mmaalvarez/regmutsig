...
### WARNING: shuffling n_trinuc32_at_risk
set.seed(1)
n_trinuc32_at_risk_shuffled = sample(good_mappability_regions_n_trinuc32_at_risk$n_trinuc32_at_risk)
good_mappability_regions_n_trinuc32_at_risk$n_trinuc32_at_risk = n_trinuc32_at_risk_shuffled
